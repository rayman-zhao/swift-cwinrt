...
enum __x_ABI_CWindows_CUI_CXaml_CInterop_CNotifyCollectionChangedAction
    {
        __x_ABI_CWindows_CUI_CXaml_CInterop_CNotifyCollectionChangedAction_Add = 0,
    __x_ABI_CWindows_CUI_CXaml_CInterop_CNotifyCollectionChangedAction_Remove = 1,
    __x_ABI_CWindows_CUI_CXaml_CInterop_CNotifyCollectionChangedAction_Replace = 2,
    __x_ABI_CWindows_CUI_CXaml_CInterop_CNotifyCollectionChangedAction_Move = 3,
    __x_ABI_CWindows_CUI_CXaml_CInterop_CNotifyCollectionChangedAction_Reset = 4,
};

enum __x_ABI_CWindows_CUI_CXaml_CInterop_CTypeKind
    {
        __x_ABI_CWindows_CUI_CXaml_CInterop_CTypeKind_Primitive = 0,
    __x_ABI_CWindows_CUI_CXaml_CInterop_CTypeKind_Metadata = 1,
    __x_ABI_CWindows_CUI_CXaml_CInterop_CTypeKind_Custom = 2,
};
