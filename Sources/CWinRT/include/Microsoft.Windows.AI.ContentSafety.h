...
enum __x_ABI_CMicrosoft_CWindows_CAI_CContentSafety_CSeverityLevel
    {
        __x_ABI_CMicrosoft_CWindows_CAI_CContentSafety_CSeverityLevel_Minimum = 10,
    __x_ABI_CMicrosoft_CWindows_CAI_CContentSafety_CSeverityLevel_Low = 11,
    __x_ABI_CMicrosoft_CWindows_CAI_CContentSafety_CSeverityLevel_Medium = 12,
    __x_ABI_CMicrosoft_CWindows_CAI_CContentSafety_CSeverityLevel_High = 13,
};
