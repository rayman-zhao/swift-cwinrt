...
enum __x_ABI_CMicrosoft_CUI_CText_CCaretType
    {
        __x_ABI_CMicrosoft_CUI_CText_CCaretType_Normal = 0,
    __x_ABI_CMicrosoft_CUI_CText_CCaretType_Null = 1,
};

enum __x_ABI_CMicrosoft_CUI_CText_CFindOptions
    {
        __x_ABI_CMicrosoft_CUI_CText_CFindOptions_None = 0,
    __x_ABI_CMicrosoft_CUI_CText_CFindOptions_Word = 0x2,
    __x_ABI_CMicrosoft_CUI_CText_CFindOptions_Case = 0x4,
};

enum __x_ABI_CMicrosoft_CUI_CText_CFormatEffect
    {
        __x_ABI_CMicrosoft_CUI_CText_CFormatEffect_Off = 0,
    __x_ABI_CMicrosoft_CUI_CText_CFormatEffect_On = 1,
    __x_ABI_CMicrosoft_CUI_CText_CFormatEffect_Toggle = 2,
    __x_ABI_CMicrosoft_CUI_CText_CFormatEffect_Undefined = 3,
};

enum __x_ABI_CMicrosoft_CUI_CText_CHorizontalCharacterAlignment
    {
        __x_ABI_CMicrosoft_CUI_CText_CHorizontalCharacterAlignment_Left = 0,
    __x_ABI_CMicrosoft_CUI_CText_CHorizontalCharacterAlignment_Right = 1,
    __x_ABI_CMicrosoft_CUI_CText_CHorizontalCharacterAlignment_Center = 2,
};

enum __x_ABI_CMicrosoft_CUI_CText_CLetterCase
    {
        __x_ABI_CMicrosoft_CUI_CText_CLetterCase_Lower = 0,
    __x_ABI_CMicrosoft_CUI_CText_CLetterCase_Upper = 1,
};

enum __x_ABI_CMicrosoft_CUI_CText_CLineSpacingRule
    {
        __x_ABI_CMicrosoft_CUI_CText_CLineSpacingRule_Undefined = 0,
    __x_ABI_CMicrosoft_CUI_CText_CLineSpacingRule_Single = 1,
    __x_ABI_CMicrosoft_CUI_CText_CLineSpacingRule_OneAndHalf = 2,
    __x_ABI_CMicrosoft_CUI_CText_CLineSpacingRule_Double = 3,
    __x_ABI_CMicrosoft_CUI_CText_CLineSpacingRule_AtLeast = 4,
    __x_ABI_CMicrosoft_CUI_CText_CLineSpacingRule_Exactly = 5,
    __x_ABI_CMicrosoft_CUI_CText_CLineSpacingRule_Multiple = 6,
    __x_ABI_CMicrosoft_CUI_CText_CLineSpacingRule_Percent = 7,
};

enum __x_ABI_CMicrosoft_CUI_CText_CLinkType
    {
        __x_ABI_CMicrosoft_CUI_CText_CLinkType_Undefined = 0,
    __x_ABI_CMicrosoft_CUI_CText_CLinkType_NotALink = 1,
    __x_ABI_CMicrosoft_CUI_CText_CLinkType_ClientLink = 2,
    __x_ABI_CMicrosoft_CUI_CText_CLinkType_FriendlyLinkName = 3,
    __x_ABI_CMicrosoft_CUI_CText_CLinkType_FriendlyLinkAddress = 4,
    __x_ABI_CMicrosoft_CUI_CText_CLinkType_AutoLink = 5,
    __x_ABI_CMicrosoft_CUI_CText_CLinkType_AutoLinkEmail = 6,
    __x_ABI_CMicrosoft_CUI_CText_CLinkType_AutoLinkPhone = 7,
    __x_ABI_CMicrosoft_CUI_CText_CLinkType_AutoLinkPath = 8,
};

enum __x_ABI_CMicrosoft_CUI_CText_CMarkerAlignment
    {
        __x_ABI_CMicrosoft_CUI_CText_CMarkerAlignment_Undefined = 0,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerAlignment_Left = 1,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerAlignment_Center = 2,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerAlignment_Right = 3,
};

enum __x_ABI_CMicrosoft_CUI_CText_CMarkerStyle
    {
        __x_ABI_CMicrosoft_CUI_CText_CMarkerStyle_Undefined = 0,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerStyle_Parenthesis = 1,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerStyle_Parentheses = 2,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerStyle_Period = 3,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerStyle_Plain = 4,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerStyle_Minus = 5,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerStyle_NoNumber = 6,
};

enum __x_ABI_CMicrosoft_CUI_CText_CMarkerType
    {
        __x_ABI_CMicrosoft_CUI_CText_CMarkerType_Undefined = 0,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_None = 1,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_Bullet = 2,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_Arabic = 3,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_LowercaseEnglishLetter = 4,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_UppercaseEnglishLetter = 5,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_LowercaseRoman = 6,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_UppercaseRoman = 7,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_UnicodeSequence = 8,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_CircledNumber = 9,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_BlackCircleWingding = 10,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_WhiteCircleWingding = 11,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_ArabicWide = 12,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_SimplifiedChinese = 13,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_TraditionalChinese = 14,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_JapanSimplifiedChinese = 15,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_JapanKorea = 16,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_ArabicDictionary = 17,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_ArabicAbjad = 18,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_Hebrew = 19,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_ThaiAlphabetic = 20,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_ThaiNumeric = 21,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_DevanagariVowel = 22,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_DevanagariConsonant = 23,
    __x_ABI_CMicrosoft_CUI_CText_CMarkerType_DevanagariNumeric = 24,
};

enum __x_ABI_CMicrosoft_CUI_CText_CParagraphAlignment
    {
        __x_ABI_CMicrosoft_CUI_CText_CParagraphAlignment_Undefined = 0,
    __x_ABI_CMicrosoft_CUI_CText_CParagraphAlignment_Left = 1,
    __x_ABI_CMicrosoft_CUI_CText_CParagraphAlignment_Center = 2,
    __x_ABI_CMicrosoft_CUI_CText_CParagraphAlignment_Right = 3,
    __x_ABI_CMicrosoft_CUI_CText_CParagraphAlignment_Justify = 4,
};

enum __x_ABI_CMicrosoft_CUI_CText_CParagraphStyle
    {
        __x_ABI_CMicrosoft_CUI_CText_CParagraphStyle_Undefined = 0,
    __x_ABI_CMicrosoft_CUI_CText_CParagraphStyle_None = 1,
    __x_ABI_CMicrosoft_CUI_CText_CParagraphStyle_Normal = 2,
    __x_ABI_CMicrosoft_CUI_CText_CParagraphStyle_Heading1 = 3,
    __x_ABI_CMicrosoft_CUI_CText_CParagraphStyle_Heading2 = 4,
    __x_ABI_CMicrosoft_CUI_CText_CParagraphStyle_Heading3 = 5,
    __x_ABI_CMicrosoft_CUI_CText_CParagraphStyle_Heading4 = 6,
    __x_ABI_CMicrosoft_CUI_CText_CParagraphStyle_Heading5 = 7,
    __x_ABI_CMicrosoft_CUI_CText_CParagraphStyle_Heading6 = 8,
    __x_ABI_CMicrosoft_CUI_CText_CParagraphStyle_Heading7 = 9,
    __x_ABI_CMicrosoft_CUI_CText_CParagraphStyle_Heading8 = 10,
    __x_ABI_CMicrosoft_CUI_CText_CParagraphStyle_Heading9 = 11,
};

enum __x_ABI_CMicrosoft_CUI_CText_CPointOptions
    {
        __x_ABI_CMicrosoft_CUI_CText_CPointOptions_None = 0,
    __x_ABI_CMicrosoft_CUI_CText_CPointOptions_IncludeInset = 0x1,
    __x_ABI_CMicrosoft_CUI_CText_CPointOptions_Start = 0x20,
    __x_ABI_CMicrosoft_CUI_CText_CPointOptions_ClientCoordinates = 0x100,
    __x_ABI_CMicrosoft_CUI_CText_CPointOptions_AllowOffClient = 0x200,
    __x_ABI_CMicrosoft_CUI_CText_CPointOptions_Transform = 0x400,
    __x_ABI_CMicrosoft_CUI_CText_CPointOptions_NoHorizontalScroll = 0x10000,
    __x_ABI_CMicrosoft_CUI_CText_CPointOptions_NoVerticalScroll = 0x40000,
};

enum __x_ABI_CMicrosoft_CUI_CText_CRangeGravity
    {
        __x_ABI_CMicrosoft_CUI_CText_CRangeGravity_UIBehavior = 0,
    __x_ABI_CMicrosoft_CUI_CText_CRangeGravity_Backward = 1,
    __x_ABI_CMicrosoft_CUI_CText_CRangeGravity_Forward = 2,
    __x_ABI_CMicrosoft_CUI_CText_CRangeGravity_Inward = 3,
    __x_ABI_CMicrosoft_CUI_CText_CRangeGravity_Outward = 4,
};

enum __x_ABI_CMicrosoft_CUI_CText_CRichEditMathMode
    {
        __x_ABI_CMicrosoft_CUI_CText_CRichEditMathMode_NoMath = 0,
    __x_ABI_CMicrosoft_CUI_CText_CRichEditMathMode_MathOnly = 1,
};

enum __x_ABI_CMicrosoft_CUI_CText_CSelectionOptions
    {
        __x_ABI_CMicrosoft_CUI_CText_CSelectionOptions_StartActive = 0x1,
    __x_ABI_CMicrosoft_CUI_CText_CSelectionOptions_AtEndOfLine = 0x2,
    __x_ABI_CMicrosoft_CUI_CText_CSelectionOptions_Overtype = 0x4,
    __x_ABI_CMicrosoft_CUI_CText_CSelectionOptions_Active = 0x8,
    __x_ABI_CMicrosoft_CUI_CText_CSelectionOptions_Replace = 0x10,
};

enum __x_ABI_CMicrosoft_CUI_CText_CSelectionType
    {
        __x_ABI_CMicrosoft_CUI_CText_CSelectionType_None = 0,
    __x_ABI_CMicrosoft_CUI_CText_CSelectionType_InsertionPoint = 1,
    __x_ABI_CMicrosoft_CUI_CText_CSelectionType_Normal = 2,
    __x_ABI_CMicrosoft_CUI_CText_CSelectionType_InlineShape = 7,
    __x_ABI_CMicrosoft_CUI_CText_CSelectionType_Shape = 8,
};

enum __x_ABI_CMicrosoft_CUI_CText_CTabAlignment
    {
        __x_ABI_CMicrosoft_CUI_CText_CTabAlignment_Left = 0,
    __x_ABI_CMicrosoft_CUI_CText_CTabAlignment_Center = 1,
    __x_ABI_CMicrosoft_CUI_CText_CTabAlignment_Right = 2,
    __x_ABI_CMicrosoft_CUI_CText_CTabAlignment_Decimal = 3,
    __x_ABI_CMicrosoft_CUI_CText_CTabAlignment_Bar = 4,
};

enum __x_ABI_CMicrosoft_CUI_CText_CTabLeader
    {
        __x_ABI_CMicrosoft_CUI_CText_CTabLeader_Spaces = 0,
    __x_ABI_CMicrosoft_CUI_CText_CTabLeader_Dots = 1,
    __x_ABI_CMicrosoft_CUI_CText_CTabLeader_Dashes = 2,
    __x_ABI_CMicrosoft_CUI_CText_CTabLeader_Lines = 3,
    __x_ABI_CMicrosoft_CUI_CText_CTabLeader_ThickLines = 4,
    __x_ABI_CMicrosoft_CUI_CText_CTabLeader_Equals = 5,
};

enum __x_ABI_CMicrosoft_CUI_CText_CTextGetOptions
    {
        __x_ABI_CMicrosoft_CUI_CText_CTextGetOptions_None = 0,
    __x_ABI_CMicrosoft_CUI_CText_CTextGetOptions_AdjustCrlf = 0x1,
    __x_ABI_CMicrosoft_CUI_CText_CTextGetOptions_UseCrlf = 0x2,
    __x_ABI_CMicrosoft_CUI_CText_CTextGetOptions_UseObjectText = 0x4,
    __x_ABI_CMicrosoft_CUI_CText_CTextGetOptions_AllowFinalEop = 0x8,
    __x_ABI_CMicrosoft_CUI_CText_CTextGetOptions_NoHidden = 0x20,
    __x_ABI_CMicrosoft_CUI_CText_CTextGetOptions_IncludeNumbering = 0x40,
    __x_ABI_CMicrosoft_CUI_CText_CTextGetOptions_FormatRtf = 0x2000,
    __x_ABI_CMicrosoft_CUI_CText_CTextGetOptions_UseLf = 0x1000000,
};

enum __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit
    {
        __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Character = 0,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Word = 1,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Sentence = 2,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Paragraph = 3,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Line = 4,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Story = 5,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Screen = 6,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Section = 7,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Window = 8,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_CharacterFormat = 9,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_ParagraphFormat = 10,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Object = 11,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_HardParagraph = 12,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Cluster = 13,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Bold = 14,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Italic = 15,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Underline = 16,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Strikethrough = 17,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_ProtectedText = 18,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Link = 19,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_SmallCaps = 20,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_AllCaps = 21,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Hidden = 22,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Outline = 23,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Shadow = 24,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Imprint = 25,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Disabled = 26,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Revised = 27,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Subscript = 28,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_Superscript = 29,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_FontBound = 30,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_LinkProtected = 31,
    __x_ABI_CMicrosoft_CUI_CText_CTextRangeUnit_ContentLink = 32,
};

enum __x_ABI_CMicrosoft_CUI_CText_CTextScript
    {
        __x_ABI_CMicrosoft_CUI_CText_CTextScript_Undefined = 0,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Ansi = 1,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_EastEurope = 2,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Cyrillic = 3,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Greek = 4,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Turkish = 5,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Hebrew = 6,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Arabic = 7,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Baltic = 8,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Vietnamese = 9,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Default = 10,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Symbol = 11,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Thai = 12,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_ShiftJis = 13,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_GB2312 = 14,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Hangul = 15,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Big5 = 16,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_PC437 = 17,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Oem = 18,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Mac = 19,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Armenian = 20,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Syriac = 21,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Thaana = 22,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Devanagari = 23,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Bengali = 24,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Gurmukhi = 25,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Gujarati = 26,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Oriya = 27,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Tamil = 28,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Telugu = 29,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Kannada = 30,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Malayalam = 31,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Sinhala = 32,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Lao = 33,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Tibetan = 34,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Myanmar = 35,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Georgian = 36,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Jamo = 37,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Ethiopic = 38,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Cherokee = 39,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Aboriginal = 40,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Ogham = 41,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Runic = 42,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Khmer = 43,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Mongolian = 44,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Braille = 45,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Yi = 46,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Limbu = 47,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_TaiLe = 48,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_NewTaiLue = 49,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_SylotiNagri = 50,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Kharoshthi = 51,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Kayahli = 52,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_UnicodeSymbol = 53,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Emoji = 54,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Glagolitic = 55,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Lisu = 56,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Vai = 57,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_NKo = 58,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Osmanya = 59,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_PhagsPa = 60,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Gothic = 61,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Deseret = 62,
    __x_ABI_CMicrosoft_CUI_CText_CTextScript_Tifinagh = 63,
};

enum __x_ABI_CMicrosoft_CUI_CText_CTextSetOptions
    {
        __x_ABI_CMicrosoft_CUI_CText_CTextSetOptions_None = 0,
    __x_ABI_CMicrosoft_CUI_CText_CTextSetOptions_UnicodeBidi = 0x1,
    __x_ABI_CMicrosoft_CUI_CText_CTextSetOptions_Unlink = 0x8,
    __x_ABI_CMicrosoft_CUI_CText_CTextSetOptions_Unhide = 0x10,
    __x_ABI_CMicrosoft_CUI_CText_CTextSetOptions_CheckTextLimit = 0x20,
    __x_ABI_CMicrosoft_CUI_CText_CTextSetOptions_FormatRtf = 0x2000,
    __x_ABI_CMicrosoft_CUI_CText_CTextSetOptions_ApplyRtfDocumentDefaults = 0x4000,
};

enum __x_ABI_CMicrosoft_CUI_CText_CUnderlineType
    {
        __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_Undefined = 0,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_None = 1,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_Single = 2,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_Words = 3,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_Double = 4,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_Dotted = 5,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_Dash = 6,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_DashDot = 7,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_DashDotDot = 8,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_Wave = 9,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_Thick = 10,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_Thin = 11,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_DoubleWave = 12,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_HeavyWave = 13,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_LongDash = 14,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_ThickDash = 15,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_ThickDashDot = 16,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_ThickDashDotDot = 17,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_ThickDotted = 18,
    __x_ABI_CMicrosoft_CUI_CText_CUnderlineType_ThickLongDash = 19,
};

enum __x_ABI_CMicrosoft_CUI_CText_CVerticalCharacterAlignment
    {
        __x_ABI_CMicrosoft_CUI_CText_CVerticalCharacterAlignment_Top = 0,
    __x_ABI_CMicrosoft_CUI_CText_CVerticalCharacterAlignment_Baseline = 1,
    __x_ABI_CMicrosoft_CUI_CText_CVerticalCharacterAlignment_Bottom = 2,
};
